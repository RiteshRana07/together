...
export async function POST(req, { params }) {
  ...
  const playableOriginalUrl = isPCloudRef(rawOriginalUrl) ? `/api/storage/stream?room=${encodeURIComponent(code)}&v=${encodeURIComponent(rawOriginalUrl)}` : rawOriginalUrl;
